...
if(CommonUtils.getLoginUserTypeCode()=='GEN'){
  ...
  +    this.service.searchCompanies(this.searchCompanyName, this.searchOrgId, this.searchcompanyServiceNumber, this.statementMonth, this.statementYear,this.companyServiceId).subscribe(
