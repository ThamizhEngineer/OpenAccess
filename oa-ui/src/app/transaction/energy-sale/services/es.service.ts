...
export class EsService {
    ...
    getAllEss(companyName:string,companyServiceNumber:string,edcId:string,companyId:string,isSTB:string,month:string,year:string,simple:string,flowTpeCode:string){
        ...
        if(companyName != "" || companyServiceNumber != "" || edcId != "" || companyId != ""  || isSTB != "" || month != "" || year!="") {
            ...
            if(flowTpeCode != "" && flowTpeCode != undefined){
                url = url + "&flowTpeCode="+flowTpeCode ;
            }  
