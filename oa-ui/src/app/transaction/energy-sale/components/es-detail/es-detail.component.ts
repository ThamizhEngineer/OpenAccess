...
export class BulkDialogComponent implements OnInit {
	...
	constructor(private router: Router, private datePipe: DatePipe, private esDetailHelper: EsDetailAllocationHelper, private gsService: GsService, public dialogRef: MatDialogRef<BulkDialogComponent>, private _hotRegisterer: HotRegisterer,public dialog: MatDialog, @Inject(MAT_DIALOG_DATA) public data: any, private service: EsService) {
	}
	ngOnInit() {
		this.es = new Es();
