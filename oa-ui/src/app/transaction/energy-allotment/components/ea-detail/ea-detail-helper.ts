...
export class EaDetailHelper implements OnInit{
	...
	*/
	...
	checkAllocatedUnits(es:Ea,gs:Gs) {
		this.es = es;
		this.gs= gs;
		this.errorMessage="";
		...
		// if (c1Total > parseFloat(this.gs.c1)) {
			if(this.gs.dispFuelTypeCode=='WIND'&&this.gs.flowTypeCode=='IS-CAPTIVE'&& parseFloat(this.es.availGc1) > c1Total){
		...
		console.log("stage3")
		if(this.gs.dispFuelTypeCode=='WIND'&&this.gs.flowTypeCode=='IS-CAPTIVE'&& parseFloat(this.es.availGc2) > c2Total){
			this.errorMessage= "Entire current month wind generation should be allotted";
			this.allocationFlag = true;
		}
		...
		console.log("stage3")
		if(this.gs.dispFuelTypeCode=='WIND'&&this.gs.flowTypeCode=='IS-CAPTIVE'&&parseFloat(this.es.availGc3) > c3Total){
			this.errorMessage= "Entire current month wind generation should be allotted";
			this.allocationFlag = true;
		}
		...
		console.log("stage3")
		if(this.gs.dispFuelTypeCode=='WIND'&&this.gs.flowTypeCode=='IS-CAPTIVE'&&parseFloat(this.es.availGc4) > c4Total){
			this.errorMessage= "Entire current month wind generation should be allotted";
			this.allocationFlag = true;
		}
		...
		console.log("stage3")
		if(this.gs.dispFuelTypeCode=='WIND'&&this.gs.flowTypeCode=='IS-CAPTIVE'&&parseFloat(this.es.availGc5) > c5Total){
			this.errorMessage= "Entire current month wind generation should be allotted";
			this.allocationFlag = true;
		}
