...
export class EaDetailComponent implements OnInit {
  ...
  fetchGsById() { 
    this.gsService.getGsById(this.es.generationStatementId).subscribe(
      _gs => {
        ...
        var result1 = this.eaDetailHelper.checkAllocatedUnits(this.es, this.gs);
       ...
       //this.blocktransflag = true;
       console.log(this.gs)
       console.log(this.gs.dispFuelTypeGroup)
       console.log("after")
            }
    )
  }
  ...
  checkBlockStatus(){
    ...
    this.service.test(this.es.sellerCompanyServiceNumber,this.es.month,this.es.year).subscribe(
      _deltrans => {
        console.log(_deltrans)
        this.bl=_deltrans
        console.log(this.bl.status)
        console.log(this.bl.mCompServiceNumber)
        console.log("In search result")
        if(this.bl != null && this.bl.status=='Block' && this.es.sellerCompanyServiceNumber==this.bl.mCompServiceNumber){
          this.blocktransflag = true;
