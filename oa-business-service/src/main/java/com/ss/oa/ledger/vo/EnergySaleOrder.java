...
public class EnergySaleOrder {
	...
	private List<EnergySaleOrderLine> energySaleOrderLines;
	private List<EnergyCharge> energyCharge;
	
	public EnergySaleOrder() {
		super();
	}

	@Override
	public String toString() {
		return "EnergySaleOrder [id=" + id + ", energySaleId=" + energySaleId + ", sellerCompanyServiceId="
				...
				+ ", fromDate=" + fromDate + ", toDate=" + toDate + ", loss=" + loss + ", multipleBuyers="
				+ multipleBuyers + ", usageDetailAvail=" + usageDetailAvail + ", simpleEnergySale=" + simpleEnergySale
				+ ", totalC1=" + totalC1 + ", totalC2=" + totalC2 + ", totalC3=" + totalC3 + ", totalC4=" + totalC4
				+ ", totalC5=" + totalC5 + ", totalGenUnitsSold=" + totalGenUnitsSold + ", totalBc1=" + totalBc1
				+ ", totalBc2=" + totalBc2 + ", totalBc3=" + totalBc3 + ", totalBc4=" + totalBc4 + ", totalBc5="
				+ totalBc5 + ", totalBankingUnitsSold=" + totalBankingUnitsSold + ", totalUnitsSold=" + totalUnitsSold
				+ ", allowLowerSlotAdmt=" + allowLowerSlotAdmt + ", sellerCompanyName=" + sellerCompanyName
				+ ", sellerCompanyCode=" + sellerCompanyCode + ", sellerCompanyId=" + sellerCompanyId
				+ ", sellerCompanyServiceNumber=" + sellerCompanyServiceNumber + ", sellerCompanyServiceTypeCode="
				+ sellerCompanyServiceTypeCode + ", sellerCompBankingServiceId=" + sellerCompBankingServiceId
				+ ", sellerCompBankingServiceNumber=" + sellerCompBankingServiceNumber + ", sellerTlServiceId="
				+ sellerTlServiceId + ", sellerTlServiceNumber=" + sellerTlServiceNumber + ", sellerDlServiceId="
				+ sellerDlServiceId + ", sellerDlServiceNumber=" + sellerDlServiceNumber
				+ ", sellerUnAdjustedServiceId=" + sellerUnAdjustedServiceId + ", sellerUnAdjustedServiceNumber="
				+ sellerUnAdjustedServiceNumber + ", sellerEndOrgName=" + sellerEndOrgName + ", sellerEndOrgCode="
				+ sellerEndOrgCode + ", sellerEndFeederId=" + sellerEndFeederId + ", sellerEndFeederName="
				+ sellerEndFeederName + ", sellerEndFeederCode=" + sellerEndFeederCode + ", sellerEndSubstationId="
				+ sellerEndSubstationId + ", sellerEndSubstationName=" + sellerEndSubstationName
				+ ", sellerEndSubstationCode=" + sellerEndSubstationCode + ", totalGc1=" + totalGc1 + ", totalGc2="
				+ totalGc2 + ", totalGc3=" + totalGc3 + ", totalGc4=" + totalGc4 + ", totalGc5=" + totalGc5
				+ ", fuelTypeCode=" + fuelTypeCode + ", fuelTypeName=" + fuelTypeName + ", fuelGroupe=" + fuelGroupe
				+ ", createdDate=" + createdDate + ", energySaleOrderLines=" + energySaleOrderLines + ", energyCharge="
				+ energyCharge + "]";
	}

	public EnergySaleOrder(String id, String energySaleId, String sellerCompanyServiceId, String sellerEndOrgId,
			String year, String month, String injectingVoltageCode, String injectingVoltageName, String fromDate,
			String toDate, String loss, String multipleBuyers, String usageDetailAvail, String simpleEnergySale,
			String totalC1, String totalC2, String totalC3, String totalC4, String totalC5, String totalGenUnitsSold,
			String totalBc1, String totalBc2, String totalBc3, String totalBc4, String totalBc5,
			String totalBankingUnitsSold, String totalUnitsSold, String allowLowerSlotAdmt, String sellerCompanyName,
			String sellerCompanyCode, String sellerCompanyId, String sellerCompanyServiceNumber,
			String sellerCompanyServiceTypeCode, String sellerCompBankingServiceId,
			...
			String fuelTypeName, String fuelGroupe, String createdDate, List<EnergySaleOrderLine> energySaleOrderLines,
	...
	public List<EnergySaleOrderLine> getEnergySaleOrderLines() {
		return energySaleOrderLines;
	}

	public void setEnergySaleOrderLines(List<EnergySaleOrderLine> energySaleOrderLines) {
		this.energySaleOrderLines = energySaleOrderLines;
	}
