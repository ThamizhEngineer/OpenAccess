...
@Scope("prototype")
public class EnergySaleOrderLine {
	...
	public EnergySaleOrderLine() {
		super();
	}

	public EnergySaleOrderLine(String id, String energySaleOrderId, String energySaleId, String buyerEndOrgId,
	...
	public String toString() {
		return "EnergySaleOrderLine [id=" + id + ", energySaleOrderId=" + energySaleOrderId + ", energySaleId="
