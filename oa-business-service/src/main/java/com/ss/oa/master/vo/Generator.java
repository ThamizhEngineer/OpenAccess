...
public class Generator {
	...
	public Generator(String id, String powerplantId, String name, String makeCode, String makeName, String serialNumber,
			...
			String enabled, String noOfUnits, String make, String mwRating, String mvRating, String kvRating,
			...
			String finalCod, String finalCopd, String isCaptive, String createdBy, String createdDate,
			String modifiedBy, String modifiedDate, String remarks) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Generator [id=" + id + ", powerplantId=" + powerplantId + ", name=" + name + ", makeCode=" + makeCode
				...
				+ voltageCode + ", voltageName=" + voltageName + ", enabled=" + enabled + ", noOfUnits=" + noOfUnits
				+ ", make=" + make + ", mwRating=" + mwRating + ", mvRating=" + mvRating + ", kvRating=" + kvRating
				+ ", dampingFactor=" + dampingFactor + ", amateurResistance=" + amateurResistance
				+ ", directAssistanceReactance=" + directAssistanceReactance + ", negativeSequenceReactance="
				+ negativeSequenceReactance + ", zeroSequenceReactance=" + zeroSequenceReactance
				+ ", directAxisTransientReactance=" + directAxisTransientReactance
				+ ", quadratureAxisTransientReactance=" + quadratureAxisTransientReactance
				+ ", directAxisSubTransientReactance=" + directAxisSubTransientReactance + ", inertia=" + inertia
				+ ", windingConnection=" + windingConnection + ", massNumber=" + massNumber + ", stiffnessCoefficient="
				+ stiffnessCoefficient + ", status=" + status + ", gcId=" + gcId + ", finalCod=" + finalCod
				+ ", finalCopd=" + finalCopd + ", isCaptive=" + isCaptive + ", createdBy=" + createdBy
