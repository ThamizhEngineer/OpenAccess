...
public class CsEquityShareVotingRight {
	...
	public CsEquityShareVotingRight() {
		super();
		// TODO Auto-generated constructor stub
	}

	public CsEquityShareVotingRight(String id, String csId, String classOfEquityShares, String noOfEquityShares,
	...
	public String toString() {
		return "CsEquityShareVotingRight [id=" + id + ", csId=" + csId + ", classOfEquityShares=" + classOfEquityShares
