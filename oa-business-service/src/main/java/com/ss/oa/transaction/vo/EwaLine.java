...
public class EwaLine {
	...
	private String  ewaLineChangeCode ;
	private String  ewaLineChangeDesc ;
	...
	public EwaLine(String id, String ewaId, String ewaApprovalNumber, String buyerOrgId, String buyerOrgName,
			...
			String ewaLineChangeCode, String ewaLineChangeDesc, String remarks, String createdBy, String createdDate,
		...
		this.ewaLineChangeCode = ewaLineChangeCode;
		this.ewaLineChangeDesc = ewaLineChangeDesc;
	...
	public String toString() {
		return "EwaLine [id=" + id + ", ewaId=" + ewaId + ", ewaApprovalNumber=" + ewaApprovalNumber + ", buyerOrgId="
				+ buyerOrgId + ", buyerOrgName=" + buyerOrgName + ", buyerCompServiceId=" + buyerCompServiceId
				...
				+ ", statusDesc=" + statusDesc + ", ewaLineChangeCode=" + ewaLineChangeCode + ", ewaLineChangeDesc="
				+ ewaLineChangeDesc + ", remarks=" + remarks + ", createdBy=" + createdBy + ", createdDate="
	...
	public String getEwaLineChangeCode() {
		return ewaLineChangeCode;
	}


	public String getEwaLineChangeDesc() {
		return ewaLineChangeDesc;
	}
	...
	public void setEwaLineChangeCode(String ewaLineChangeCode) {
		this.ewaLineChangeCode = ewaLineChangeCode;
	}


	public void setEwaLineChangeDesc(String ewaLineChangeDesc) {
		this.ewaLineChangeDesc = ewaLineChangeDesc;
	}
