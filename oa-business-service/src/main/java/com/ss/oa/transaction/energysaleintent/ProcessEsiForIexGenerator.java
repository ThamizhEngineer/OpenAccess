...
@Scope("prototype")
@Component
public class ProcessEsiForIexGenerator {
	
	public ProcessEsiForIexGenerator() {
		super();
	...
	public String processEnergySaleIntentForIexGenerator(EnergySaleIntent energySaleIntent) {
		System.out.println("IEX-GENERATOR");
		...
		if (energySaleIntent.getFlowTypeCode().equals("IEX-GENERATOR")) {
			...
			if (energySaleIntent.getEnergySaleIntentLines() != null) {
				for (EnergySaleIntentLine energySaleIntentLine : energySaleIntent.getEnergySaleIntentLines()) {
					if (energySaleIntentLine.getId() != null) {							
						...
						}else if ( energySaleIntent.getIpaaId()!=null&& (energySaleIntentLine.getNocId() == null || energySaleIntentLine.getNocId().isEmpty())){
