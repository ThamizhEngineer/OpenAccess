...
public class CaptiveUserContribution {
	...
	public CaptiveUserContribution() {
		super();
	}

	public CaptiveUserContribution(String id, String gcId, String classOfShareHolder, String noOfEquityShares,
	...
	public String toString() {
		return "CaptiveUserContribution [id=" + id + ", gcId=" + gcId + ", classOfShareHolder=" + classOfShareHolder
