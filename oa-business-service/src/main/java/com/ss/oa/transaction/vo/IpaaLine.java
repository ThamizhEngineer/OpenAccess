...
public class IpaaLine {
	private String  id ;
	private String  ipaaId ;
	...
	public IpaaLine(String id, String ipaaId, String buyerOrgId, String buyerOrgName, String buyerCompServiceId,
			String buyerCompServiceNumber, String buyerCompanyName, String buyerCompanyId, String buyerCapacity,
			String drawalVoltageCode, String drawalVoltageDesc, String injectionVoltageCode,
	...
	public String toString() {
		return "IpaaLine [id=" + id + ", ipaaId=" + ipaaId + ", buyerOrgId=" + buyerOrgId + ", buyerOrgName="
				+ buyerOrgName + ", buyerCompServiceId=" + buyerCompServiceId + ", buyerCompServiceNumber="
				+ buyerCompServiceNumber + ", buyerCompanyName=" + buyerCompanyName + ", buyerCompanyId="
				+ buyerCompanyId + ", buyerCapacity=" + buyerCapacity + ", drawalVoltageCode=" + drawalVoltageCode
				+ ", drawalVoltageDesc=" + drawalVoltageDesc + ", injectionVoltageCode=" + injectionVoltageCode
				+ ", injectionVoltageDesc=" + injectionVoltageDesc + ", injectionPeakUnits=" + injectionPeakUnits
				+ ", injectionOffPeakUnits=" + injectionOffPeakUnits + ", loss=" + loss + ", drawalPeakUnits="
				+ drawalPeakUnits + ", drawalOffPeakUnits=" + drawalOffPeakUnits + ", proposedUnits=" + proposedUnits
				+ ", approvedUnits=" + approvedUnits + ", isCaptive=" + isCaptive + ", appliedDate=" + appliedDate
				+ ", approvedDate=" + approvedDate + ", statusCode=" + statusCode + ", statusDesc=" + statusDesc
