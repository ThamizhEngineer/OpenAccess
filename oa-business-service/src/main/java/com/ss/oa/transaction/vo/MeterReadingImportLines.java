...
public class MeterReadingImportLines {
	
	private String id;
	private String statusCode,statusName;
	private String remarks;
	private String impMrHeaderId;
	...
	public MeterReadingImportLines() {
		super();
	}
	...
	public String getImpMrHeaderId() {
		return impMrHeaderId;
	}

	public void setImpMrHeaderId(String impMrHeaderId) {
		this.impMrHeaderId = impMrHeaderId;
	}
	...
	public String toString() {
		return "MeterReadingImportLines [id=" + id + ", statusCode=" + statusCode + ", statusName=" + statusName
				+ ", remarks=" + remarks + ", impMrHeaderId=" + impMrHeaderId + ", meterNumber=" + meterNumber + ", mf="
				+ mf + ", serviceNumber=" + serviceNumber + ", systemDate=" + systemDate + ", initReadingDate="
				+ initReadingDate + ", finalReadingDate=" + finalReadingDate + ", impInitS1=" + impInitS1
				+ ", impInitS2=" + impInitS2 + ", impInitS3=" + impInitS3 + ", impInitS4=" + impInitS4 + ", impInitS5="
				+ impInitS5 + ", impFinalS1=" + impFinalS1 + ", impFinalS2=" + impFinalS2 + ", impFinalS3=" + impFinalS3
				+ ", impFinalS4=" + impFinalS4 + ", impFinalS5=" + impFinalS5 + ", expInitS1=" + expInitS1
				+ ", expInitS2=" + expInitS2 + ", expInitS3=" + expInitS3 + ", expInitS4=" + expInitS4 + ", expInitS5="
				+ expInitS5 + ", expFinalS1=" + expFinalS1 + ", expFinalS2=" + expFinalS2 + ", expFinalS3=" + expFinalS3
				+ ", expFinalS4=" + expFinalS4 + ", expFinalS5=" + expFinalS5 + ", impRkvahInit=" + impRkvahInit
				+ ", impRkvahFinal=" + impRkvahFinal + ", expRkvahInit=" + expRkvahInit + ", expRkvahFinal="
				+ expRkvahFinal + ", impkVahInit=" + impkVahInit + ", impkVahFinal=" + impkVahFinal + ", expkVahInit="
				+ expkVahInit + ", expkVahFinal=" + expkVahFinal + ", createdBy=" + createdBy + ", createdDate="
				+ createdDate + ", modifiedBy=" + modifiedBy + ", modifiedDate=" + modifiedDate + ", readingMonthCode="
				+ readingMonthCode + ", readingMonthName=" + readingMonthName + ", readingYear=" + readingYear + "]";
	}

	public MeterReadingImportLines(String id, String statusCode, String statusName, String remarks,
			String impMrHeaderId, String meterNumber, String mf, String serviceNumber, String systemDate,
			String initReadingDate, String finalReadingDate, String impInitS1, String impInitS2, String impInitS3,
			...
			String expFinalS4, String expFinalS5, String impRkvahInit, String impRkvahFinal, String expRkvahInit,
			String expRkvahFinal, String impkVahInit, String impkVahFinal, String expkVahInit, String expkVahFinal,
			String createdBy, String createdDate, String modifiedBy, String modifiedDate, String readingMonthCode,
			String readingMonthName, String readingYear) {
		super();
		this.id = id;
		this.statusCode = statusCode;
		this.statusName = statusName;
