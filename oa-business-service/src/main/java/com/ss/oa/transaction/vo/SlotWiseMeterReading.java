...
public class SlotWiseMeterReading {
	  ...
	  private String impInitS1;
	  private String impInitS2;
	  private String impInitS3;
	  private String impInitS4;
	  private String impInitS5;
	  private String impFinalS1;
	  private String impFinalS2;
	  private String impFinalS3;
	  private String impFinalS4;
	  private String impFinalS5;
	  private String expInitS1;
	  private String expInitS2;
	  private String expInitS3;
	  private String expInitS4;
	  private String expInitS5;
	  private String expFinalS1;
	  private String expFinalS2;
	  private String expFinalS3;
	  private String expFinalS4;
	  private String expFinalS5;
	  private String impKvahInit;
	  private String expKvahInit;
	  private String impKvahFinal;
	  private String expKvahFinal;
	  private String q1KvarhInit;
	  private String q2KvarhInit;
	  private String q3KvarhInit;
	  private String q4KvarhInit;
	  private String q1KvarhFinal;
	  private String q2KvarhFinal;
	  private String q3KvarhFinal;
	  private String q4KvarhFinal;
	  private String month;
	  private String year;
	  private String downlodestatus;
	  
	public SlotWiseMeterReading(){
		super();
	}

	public SlotWiseMeterReading(String id, String meterNumber, String mF, String serviceNumber, String systemDate,
			String initialReadingDate, String finalReadingDate, String impInitS1, String impInitS2, String impInitS3,
			String impInitS4, String impInitS5, String impFinalS1, String impFinalS2, String impFinalS3,
			String impFinalS4, String impFinalS5, String expInitS1, String expInitS2, String expInitS3,
			String expInitS4, String expInitS5, String expFinalS1, String expFinalS2, String expFinalS3,
			String expFinalS4, String expFinalS5, String impKvahInit, String expKvahInit, String impKvahFinal,
			String expKvahFinal, String q1KvarhInit, String q2KvarhInit, String q3KvarhInit, String q4KvarhInit,
			String q1KvarhFinal, String q2KvarhFinal, String q3KvarhFinal, String q4KvarhFinal, String month,
			String year) {
		super();
		this.id = id;
	...
	public String toString() {
		return "SlotWiseMeterReading [id=" + id + ", meterNumber=" + meterNumber + ", mF=" + mF + ", serviceNumber="
				...
				+ ", impInitS3=" + impInitS3 + ", impInitS4=" + impInitS4 + ", impInitS5=" + impInitS5 + ", impFinalS1="
				+ impFinalS1 + ", impFinalS2=" + impFinalS2 + ", impFinalS3=" + impFinalS3 + ", impFinalS4="
				+ impFinalS4 + ", impFinalS5=" + impFinalS5 + ", expInitS1=" + expInitS1 + ", expInitS2=" + expInitS2
				...
				+ expFinalS4 + ", expFinalS5=" + expFinalS5 + ", impKvahInit=" + impKvahInit + ", expKvahInit="
				+ expKvahInit + ", impKvahFinal=" + impKvahFinal + ", expKvahFinal=" + expKvahFinal + ", q1KvarhInit="
				+ q1KvarhInit + ", q2KvarhInit=" + q2KvarhInit + ", q3KvarhInit=" + q3KvarhInit + ", q4KvarhInit="
				+ q4KvarhInit + ", q1KvarhFinal=" + q1KvarhFinal + ", q2KvarhFinal=" + q2KvarhFinal + ", q3KvarhFinal="
				+ q3KvarhFinal + ", q4KvarhFinal=" + q4KvarhFinal + ", month=" + month + ", year=" + year + "]";
	}
	...
	public String getDownlodestatus() {
		return downlodestatus;
	}

	public void setDownlodestatus(String downlodestatus) {
		this.downlodestatus = downlodestatus;
	}
