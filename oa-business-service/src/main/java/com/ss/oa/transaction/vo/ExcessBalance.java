...
public class ExcessBalance {
	...
	public String toString() {
		return "ExcessBalance [id=" + id + ", excessUnitType=" + excessUnitType + ", readingMonth=" + readingMonth
				...
				+ ", currRemarks=" + currRemarks + ", currUpdateDt=" + currUpdateDt
				+ ", remarks=" + remarks + ", createdBy=" + createdBy + ", createdDt=" + createdDt + ", modifiedBy="
				+ modifiedBy + ", modifiedDt=" + modifiedDt + ", enabled=" + enabled + "]";
	}
