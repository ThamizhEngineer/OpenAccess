...
--------------------------------------------------------
DROP FUNCTION "OPENACCESS"."PROCESS_GEN_STMT";
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "OPENACCESS"."T_PROCESS_GS_SEQ"  MINVALUE 0 MAXVALUE 1000000 INCREMENT BY 1 START WITH 220 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
		...
		LOOP
			BEGIN
				...
				if(v_no_records) THEN
					...
					v_log_result := log_activity('PROCEDURE','PROCESS_GEN_STMT','STARTED','Start - '||v_process_id,null,v_created_By, v_created_Date);
