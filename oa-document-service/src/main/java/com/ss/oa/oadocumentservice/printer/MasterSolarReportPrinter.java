...
@Service
public class MasterSolarReportPrinter {
	 @Value("${file.location}")
	    private String fileLocation;
	    
	    @Value("${master-solar-report.url}")
	    ...
	    private  final String TEMPLATE_NAME = "master-solar";
	...
	public Context setContext(List<GenericReportOutput> masterSolar,PrintPayload pl) {
	    ...
	    try {
	        ...
	        System.out.println("test"+masterSolar);

	        ctx.setVariable("masterSolar", masterSolar);
