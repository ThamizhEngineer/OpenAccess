...
public class UnalloctedGenStmtReport {
	...
	public UnalloctedGenStmtReport() {
		super();
		// TODO Auto-generated constructor stub
	}

	public UnalloctedGenStmtReport(String dispCompanyName, String dispOrgName, String dispServiceNumber,
			String netGeneration, Date stmtGenDate, String stmtMonth, String stmtYear, String statusCode,
			String schedulingCharges, String systemOperationCharges, String transmissionCharges,
			String meterReadingCharges, String negativeEnergyCharges, String omCharges, String rkvahPenalty,
			String totalExportGen, String totalImportGen) {
		super();
	...
	public String toString() {
		return "UnalloctedGenStmtReport [dispCompanyName=" + dispCompanyName + ", dispOrgName=" + dispOrgName
				+ ", dispServiceNumber=" + dispServiceNumber + ", netGeneration=" + netGeneration + ", stmtGenDate="
				+ stmtGenDate + ", stmtMonth=" + stmtMonth + ", stmtYear=" + stmtYear + ", StatusCode=" + StatusCode
				+ ", schedulingCharges=" + schedulingCharges + ", systemOperationCharges=" + systemOperationCharges
				+ ", transmissionCharges=" + transmissionCharges + ", meterReadingCharges=" + meterReadingCharges
				+ ", negativeEnergyCharges=" + negativeEnergyCharges + ", omCharges=" + omCharges + ", rkvahPenalty="
				+ rkvahPenalty + ", totalExportGen=" + totalExportGen + ", totalImportGen=" + totalImportGen + "]";
	}
