...
@Service
public class ConsEnergyAdjustedChargesReportPrint {

	@Value("${file.location}")
	private String fileLocation;

	@Value("${consolidate-energy-adjustment-charges-report.url}")
	...
	private final String TEMPLATE_NAME = "cons-energy-adjusted-charges-report";
	...
	public Context setContext(List<GenericReportOutput> cons) {
		final Context ctx = new Context(Locale.ENGLISH);
		
		try {
			System.out.println("helo" + cons);
			ctx.setVariable("cons", cons);
