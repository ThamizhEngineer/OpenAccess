...
public class TechnicalInfoReport {
	...
	@Value("${technical-info-report.url}")
	...
	private  final String TEMPLATE_NAME = "technical-info-report";
...
public Context setContext(List<GenericReportOutput> technicalInfoReport) {
	final Context ctx = new Context(Locale.ENGLISH);
	
	
	try {
		System.out.println("in context--");
		System.out.println("test"+technicalInfoReport);

		ctx.setVariable("technicalInfoReport", technicalInfoReport);
