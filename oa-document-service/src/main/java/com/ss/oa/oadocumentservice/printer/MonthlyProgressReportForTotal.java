...
public class MonthlyProgressReportForTotal {
	 
    @Value("${file.location}")
    private String fileLocation;
    
    @Value("${monthly-progress-total-report.url}")
    ...
    private  final String TEMPLATE_NAME = "monthly-progress-report-total";
...
public Context setContext(List<GenericReportOutput> meterReadingImportReport,PrintPayload pl) {
    ...
    try {
        ...
        System.out.println("in context--"+ip6);
        System.out.println("test"+meterReadingImportReport);
       ctx.setVariable("ip6", ip6);
