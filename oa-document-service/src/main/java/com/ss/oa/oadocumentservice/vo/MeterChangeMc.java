...
public class MeterChangeMc {
	...
	//@SequenceGenerator(name = "T_GEN_STMT_SLOT_MC_SEQ", sequenceName = "T_GEN_STMT_SLOT_MC_SEQ",allocationSize=1)
	...
	@Column(name = "NET_C1")
	private String Net_C1;
	@Column(name = "NET_C2")
	private String Net_C2;
	@Column(name = "NET_C3")
	private String Net_C3;
	@Column(name = "NET_C4")
	private String Net_C4;
	@Column(name = "NET_C5")
	private String Net_C5;
	...
	public String getNet_C1() {
		return Net_C1;
	}
	public void setNet_C1(String net_C1) {
		Net_C1 = net_C1;
	}
	public String getNet_C2() {
		return Net_C2;
	}
	public void setNet_C2(String net_C2) {
		Net_C2 = net_C2;
	}
	public String getNet_C3() {
		return Net_C3;
	}
	public void setNet_C3(String net_C3) {
		Net_C3 = net_C3;
	}
	public String getNet_C4() {
		return Net_C4;
	}
	public void setNet_C4(String net_C4) {
		Net_C4 = net_C4;
	}
	public String getNet_C5() {
		return Net_C5;
	}
	public void setNet_C5(String net_C5) {
		Net_C5 = net_C5;
	}
	...
	public String toString() {
		return "MeterChangeMc [Id=" + Id + ", ServiceNo=" + ServiceNo + ", ReadingMonth=" + ReadingMonth
				...
				+ DiffExpC4 + ", DiffExpC5=" + DiffExpC5 + ", Net_C1=" + Net_C1 + ", Net_C2=" + Net_C2 + ", Net_C3="
				+ Net_C3 + ", Net_C4=" + Net_C4 + ", Net_C5=" + Net_C5 + ", Meterno=" + Meterno + ", getId()=" + getId()
				+ ", getServiceNo()=" + getServiceNo() + ", getReadingMonth()=" + getReadingMonth()
				+ ", getReadingYear()=" + getReadingYear() + ", getImpInitC1()=" + getImpInitC1() + ", getImpInitC2()="
				+ getImpInitC2() + ", getImpInitC3()=" + getImpInitC3() + ", getImpInitC4()=" + getImpInitC4()
				+ ", getImpInitC5()=" + getImpInitC5() + ", getImpFinC1()=" + getImpFinC1() + ", getImpFinC2()="
				+ getImpFinC2() + ", getImpFinC3()=" + getImpFinC3() + ", getImpFinC4()=" + getImpFinC4()
				+ ", getImpFinC5()=" + getImpFinC5() + ", getExpInitC1()=" + getExpInitC1() + ", getExpInitC2()="
				+ getExpInitC2() + ", getExpInitC3()=" + getExpInitC3() + ", getExpInitC4()=" + getExpInitC4()
				+ ", getExpInitC5()=" + getExpInitC5() + ", getExpFinC1()=" + getExpFinC1() + ", getExpFinC2()="
				+ getExpFinC2() + ", getExpFinC3()=" + getExpFinC3() + ", getExpFinC4()=" + getExpFinC4()
				+ ", getExpFinC5()=" + getExpFinC5() + ", getNetImpC1()=" + getNetImpC1() + ", getNetImpC2()="
				+ getNetImpC2() + ", getNetImpC3()=" + getNetImpC3() + ", getNetImpC4()=" + getNetImpC4()
				+ ", getNetImpC5()=" + getNetImpC5() + ", getNetExpC1()=" + getNetExpC1() + ", getNetExpC2()="
				+ getNetExpC2() + ", getNetExpC3()=" + getNetExpC3() + ", getNetExpC4()=" + getNetExpC4()
				+ ", getNetExpC5()=" + getNetExpC5() + ", getRemarks()=" + getRemarks() + ", getReadingType()="
				+ getReadingType() + ", getDiffImpC1()=" + getDiffImpC1() + ", getDiffImpC2()=" + getDiffImpC2()
				+ ", getDiffImpC3()=" + getDiffImpC3() + ", getDiffImpC4()=" + getDiffImpC4() + ", getDiffImpC5()="
				+ getDiffImpC5() + ", getDiffExpC1()=" + getDiffExpC1() + ", getDiffExpC2()=" + getDiffExpC2()
				+ ", getDiffExpC3()=" + getDiffExpC3() + ", getDiffExpC4()=" + getDiffExpC4() + ", getDiffExpC5()="
				+ getDiffExpC5() + ", getNet_C1()=" + getNet_C1() + ", getNet_C2()=" + getNet_C2() + ", getNet_C3()="
				+ getNet_C3() + ", getNet_C4()=" + getNet_C4() + ", getNet_C5()=" + getNet_C5() + ", getMeterno()="
				+ getMeterno() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
	public MeterChangeMc(String id, String serviceNo, String readingMonth, String readingYear, String impInitC1,
			String impInitC2, String impInitC3, String impInitC4, String impInitC5, String impFinC1, String impFinC2,
			String impFinC3, String impFinC4, String impFinC5, String expInitC1, String expInitC2, String expInitC3,
			String expInitC4, String expInitC5, String expFinC1, String expFinC2, String expFinC3, String expFinC4,
			String expFinC5, String netImpC1, String netImpC2, String netImpC3, String netImpC4, String netImpC5,
			String netExpC1, String netExpC2, String netExpC3, String netExpC4, String netExpC5, String remarks,
			String readingType, String diffImpC1, String diffImpC2, String diffImpC3, String diffImpC4,
			String diffImpC5, String diffExpC1, String diffExpC2, String diffExpC3, String diffExpC4, String diffExpC5,
			String net_C1, String net_C2, String net_C3, String net_C4, String net_C5, String meterno) {
		super();
		Id = id;
		ServiceNo = serviceNo;
		ReadingMonth = readingMonth;
