...
@Entity
@Table(name = "V_T_INPRINCIPLE_APPLN")
@Getter
public class IpaSummary {
	@Id
	...
	@Formula("(SELECT to_char(ps.APPLN_DT,'mm') FROM V_T_INPRINCIPLE_APPLN ps WHERE ps.ID=id)")
	private String month;
	@Formula("(SELECT to_char(ps.APPLN_DT,'yyyy') FROM V_T_INPRINCIPLE_APPLN ps WHERE ps.ID=id)")
	private String year;
	...
	public IpaSummary(String id, String powerSaleId, String processTypeCode, String code, String genCompServId,
			String saleTypeCode, LocalDate fromDt, LocalDate toDt, LocalDate applnDt, String proposedQuantum,
			String agmtPeriodCode, String statusCode, String genCompId, String genCompServNumber, String fuelTypeCode,
			String genEndOrgId, String genVoltageCode, LocalDate createdDate, LocalDate modifiedDate, String month,
			String year) {
		super();
		this.id = id;
	...
	public IpaSummary(String id, String powerSaleId, String processTypeCode, String code, String genCompServId,
			String saleTypeCode, LocalDate fromDt, LocalDate toDt, LocalDate applnDt, String proposedQuantum,
			String agmtPeriodCode, String statusCode, String genCompId, String genCompServNumber, String fuelTypeCode,
			String genEndOrgId, String genVoltageCode, String month, String year) {
		super();
		this.id = id;
		this.powerSaleId = powerSaleId;
		this.processTypeCode = processTypeCode;
	...
	public String toString() {
		return "IpaSummary [id=" + id + ", powerSaleId=" + powerSaleId + ", processTypeCode=" + processTypeCode
				+ ", code=" + code + ", genCompServId=" + genCompServId + ", saleTypeCode=" + saleTypeCode + ", fromDt="
				+ fromDt + ", toDt=" + toDt + ", applnDt=" + applnDt + ", proposedQuantum=" + proposedQuantum
