...
public class EwaSummary {
	...
	@Formula("(SELECT to_char(ps.APPLN_DT,'mm') FROM V_T_EWA ps WHERE ps.ID=id)")
	private String month;
	@Formula("(SELECT to_char(ps.APPLN_DT,'yyyy') FROM V_T_EWA ps WHERE ps.ID=id)")
	private String year;
	...
	public EwaSummary(String id, String powerSaleId, String processTypeCode, String code, String genCompServId,
			...
			String genVoltageCode, LocalDate createdDate, LocalDate modifiedDate, String month, String year,String genEndOrgName,String genCompName) {
		super();
		this.id = id;
	...
	public String toString() {
		return "EwaSummary [id=" + id + ", powerSaleId=" + powerSaleId + ", processTypeCode=" + processTypeCode
				...
				+ genVoltageCode + ", createdDate=" + createdDate + ", modifiedDate=" + modifiedDate + ", month="
				+ month + ", year=" + year + "]";
	}
