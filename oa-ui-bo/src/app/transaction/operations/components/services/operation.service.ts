...
export class OperationService {
    ...
    getMeterChangeMeterReadingFromMdms(month:string,year:string){

        var url = environment.serviceApiUrl+'/MeterChangeCalculation/meterChange';
        if(month != "" || year != "") {
            url = url + "?dummy=1";  
            if(month != ""){
                url = url + "&month="+month ;
    ...
    refreshmeterchange(month:string,year:string){

        var url = environment.serviceApiUrl+'/MeterChangeCalculation/refresh';
        if(month != "" || year != "") {
            url = url + "?dummy=1";  
            if(month != ""){
                url = url + "&month="+month ;
