...
export class EaService {
    ...
    getAllEss(sellerCompanyName:string,sellerCompanyServiceNumber:string,sellerEndOrgId:string,sellerCompanyId:string,sellerCompanyServiceId:string,isStb:string,month:string,year:string,simple:string, fuelTypeCode:string,flowTypeCode:string){
        var simple = simple == 'Y'? 'Y' : 'N';
        var url = environment.serviceApiUrl+'/transaction/energyallotment?simple-energy-sale='+simple;
        // var url = environment.assetsApiUrl='/assets/data/getalles.json';
