...
import { routes } from './feeder-loss-list.routing';
...
@NgModule({
  ...
  declarations: [ 
    FeederLossListComponent
    ],
  providers: [FeederLossListService,CommonService,CommonUtils]
})

export class FeederLossListModule {
