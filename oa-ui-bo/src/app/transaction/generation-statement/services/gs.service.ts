...
export class GsService {
  ...
  // }
    ...
    checkmc(dispCompanyServiceNumber: string, statementMonth: string, statementYear: string) {

        var url = environment.serviceApiUrl+'MeterChangeCalculation/MeterChangeDetail'; 
                    url = url + "?dummy=1";  
            if(dispCompanyServiceNumber!= ""){
                url = url + "&ServiceNumber="+dispCompanyServiceNumber;
            }
            if(statementMonth != ""){
                url = url + "&month="+statementMonth ;
            }
            if(statementYear != ""){
                url = url + "&year="+statementYear;
            }
    ...
    searchBuyerCompanies(orgId:string,companyServiceNumber:string,statementMonth:string,statementYear:string,fuelTypeCode:string){
        ...
        searchCompanies(dispCompanyName:string,orgId:string,companyServiceNumber:string,statementMonth:string,statementYear:string,companyServiceId:string,fuelTypeCode:string,fuelTypeName:string,flowTypeCode:string){
