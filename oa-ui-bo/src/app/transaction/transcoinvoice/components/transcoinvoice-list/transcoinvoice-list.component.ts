...
import { Listener } from "protractor/node_modules/@types/selenium-webdriver";
...
export class TranscoinvoiceListComponent {
  ...
  constructor(
    ...
    private commonUtils: CommonUtils,private dateAdapter: DateAdapter<Date>
  ) {
