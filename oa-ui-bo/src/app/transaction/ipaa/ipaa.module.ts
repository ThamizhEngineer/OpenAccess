...
import { routes } from './ipaa.routing';
...
import { IpaScComponent } from './components/ipaa-sc/ipaa-sc.component';
...
@NgModule({
  imports: [
    ...
    NgxDatatableModule,
    FormsModule,HotTableModule,
    FlexLayoutModule,CustomDirective
  ],
  entryComponents: [IpaScComponent],

  declarations: [ 
    IpaaListComponent,IpaaDetailComponent,IpaScComponent
    ],
  providers: [ CommonService,CompanyService,CommonUtils,IpaaService]
})

export class IpaaModule {
