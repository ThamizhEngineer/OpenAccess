...
import { EsOrder, EnergySaleOrderLines, EnergyCharge, EsOrderForPrint,EsOrderChargeForPrint } from '../../../energy-sale-order/components/services/esorder';
import { CommonService } from '../../../../shared/common/common.service';
import { BankingBalanceService} from '../../../../transaction/banking-balance/services/banking-balance.service'
import { saveAs } from 'file-saver';
import { EscorderService } from '../services/escorder.service';

@Component({
  selector: 'esc-order-detail',
  templateUrl: './esc-order-detail.component.html',
  styleUrls: ['./esc-order-detail.component.scss'],
  providers: [MatDatepickerModule,  MatNativeDateModule, DatePipe,CommonUtils]

})
export class EscOrderDetailComponent implements OnInit {
  esorder: EsOrder;
  ...
  constructor(
    ...
    private service: EscorderService,
  ...
  listEso() {
    this.router.navigateByUrl('/esc-order/esc-order-list');
    // to-do
