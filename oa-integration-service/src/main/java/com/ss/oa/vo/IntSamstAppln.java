...
@Table(name = "INT_SAMAST_APPLN")
@CreationTimestamp
@UpdateTimestamp
@Entity
public class IntSamstAppln {

	
	@SequenceGenerator(name = "id_INT_SAMAST_APPLN_SEQ", sequenceName = "INT_SAMAST_APPLN_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "id_INT_SAMAST_APPLN_SEQ")
	@Id
	private Integer id;
	@Column(name="APP_ID")
	...
	public String toString() {
		return "IntSamstAppln [id=" + id + ", appId=" + appId + ", applRefNo=" + applRefNo + ", applNo=" + applNo
				+ ", applDate=" + applDate + ", appCategory=" + appCategory + ", customerName=" + customerName
